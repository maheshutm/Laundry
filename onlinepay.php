...
<div class="col-sm-4 col-md-4 col-md-offset-4 ">
	<div class="panel panel-primary">
		<div class=" panel-heading text-center">SELECT CARD</div>
			<div class="panel-body">
				<form method="" action="">	
				
						<div class="col-sm-6 col-md-6 col-md-offset-3">
							<div class="radio">
								<label><input type="radio" name="radio1" onclick="document.location='depit.php'">DEPIT CARD</label>
							</div>
					
							<div class="radio">
								<label><input type="radio" name="radio1" onclick="document.location='credit.php'">CREDIT CARD</label>
							</div>
